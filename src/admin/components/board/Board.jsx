                            ...
                            <div className="containerBox_db">
                                ...
                                <div className="contentBox_db">
                                    ...
                                    <div className='menu-box two'>
                                        <div><IoDocumentText className='iconGad gone2' /><p>Porduct</p></div>
                                        <h2>15</h2>
                                        <Link to="/" className='txtcol'><p>View More</p></Link>
                                    </div>
                                    <div className='menu-box three'>
                                        <div><IoDocumentText className='iconGad gone3' /><p>Porduct</p></div>
                                        <h2>25</h2>
                                        <Link to="/" className='txtcol'><p>View More</p></Link>
                                    </div>
                                    <div className='menu-box four'>
                                        <div><IoDocumentText className='iconGad gone4' /><p>Porduct</p></div>
                                        <h2>15</h2>
                                        <Link to="/" className='txtcol'><p>View More</p></Link>
                                    </div>
                                </div>
                            ...
                            <div className="target">
                                ...
                                <div className='target-graph'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="103" viewBox="0 0 36 103" fill="none">
                                        <rect x="20" y="0.908203" width="16" height="102.092" rx="4" fill="#FFCF00" />
                                        <rect y="24.3237" width="16" height="78.6761" rx="4" fill="#4AB58E" />
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="93" viewBox="0 0 36 93" fill="none">
                                        <rect x="20" y="0.274902" width="16" height="92.7253" rx="4" fill="#FFCF00" />
                                        <rect y="24.627" width="16" height="68.3732" rx="4" fill="#4AB58E" />
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="117" viewBox="0 0 36 117" fill="none">
                                        <rect x="20" y="0.859375" width="16" height="116.141" rx="4" fill="#FFCF00" />
                                        <rect y="58.9297" width="16" height="58.0704" rx="4" fill="#4AB58E" />
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="93" viewBox="0 0 36 93" fill="none">
                                        <rect x="20" y="0.274902" width="16" height="92.7253" rx="4" fill="#FFCF00" />
                                        <rect y="24.627" width="16" height="68.3732" rx="4" fill="#4AB58E" />
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="133" viewBox="0 0 36 133" fill="none">
                                        <rect x="20" width="16" height="133" rx="4" fill="#FFCF00" />
                                        <rect y="37.4648" width="16" height="95.5352" rx="4" fill="#4AB58E" />
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="133" viewBox="0 0 36 133" fill="none">
                                        <rect x="20" width="16" height="133" rx="4" fill="#FFCF00" />
                                        <rect y="37.4648" width="16" height="95.5352" rx="4" fill="#4AB58E" />
                        ...
                        <div className="products">
                            ...
                            <div className="item_guopBox">
                                ...
                                <div className="items">
                                    <span>1</span>
                                    <span>ttt</span>
                                    <span><svg xmlns="http://www.w3.org/2000/svg" width="180" height="4" viewBox="0 0 180 4" fill="none">
                        ...
                        <div className="visit">
                            ...
                            <div className="visitor-graph">
                                <svg xmlns="http://www.w3.org/2000/svg" width="420" height="71" viewBox="0 0 420 71" fill="none">
                                    <path d="M-4.06934 49.5096C7.93066 24.1762 47.3307 -18.1904 108.931 15.0096C185.931 56.5096 200.931 84.0096 274.931 49.5096C348.931 15.0096 382.931 7.50957 440.931 49.5096C487.331 83.1096 513.931 63.5096 521.431 49.5096" stroke="#3CD856" stroke-width="4" />
                                    <svg xmlns="http://www.w3.org/2000/svg" width="420" height="115" viewBox="0 0 420 115" fill="none">
                                        <path d="M-4.06934 53.9577C20.9307 25.4577 45.3307 51.7577 106.931 84.9577C183.931 126.458 184.903 51.324 257.931 14.8103C324.931 -18.6897 382.931 22.3103 440.931 64.3103C487.331 97.9103 515.431 121.958 522.931 107.958" stroke="#EF4444" stroke-width="4" />
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="420" height="90" viewBox="0 0 420 90" fill="none">
                                        <path d="M-4.06934 14.8105C20.9307 -13.6895 45.3307 12.6105 106.931 45.8105C183.931 87.3105 189.403 60.8242 262.431 24.3105C329.431 -9.18951 381.431 26.8105 439.431 68.8105C485.831 102.41 515.431 82.8105 522.931 68.8105" stroke="#A700FF" stroke-width="4" />
                                    </svg>
                                </svg>
                            </div>
