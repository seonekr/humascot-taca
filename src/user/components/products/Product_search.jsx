      ...
      <div className='container_home'>
        <div className='_Box'>
            ...
            <div className='container_product'>
              ...
              <form className='category_form'>
                <select className='categoryFilter' value={price} onChange={handleSelectChange}>
                  <option className='listOption' value=''>
                    Categories
                  </option>
                  <option className='listOption' value='10'>
                    Cate1
                  </option>
                  <option className='listOption' value='20'>
                    Cate2
                  </option>
                  <option className='listOption' value='30'>
                    Cate3
                  </option>
                </select>
              </form>
          ...
          <div className='btn_more'>
            <button className='loadmore_btn_more'>View More</button>
          </div>
        </div>
      </div>
      <Menu />
