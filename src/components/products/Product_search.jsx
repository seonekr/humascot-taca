    ...
    <div className="container_home">
      <div className="content_Box">
        <div className="container_head_search">
          <a href="#">
            <box-icon name="chevron-left" id="cancel_icon"></box-icon>
          </a>
        ...
        <div className="content_itemBox">
              ...
              <div className="container_product_category">
                <form className="cetegory_form">
                  ...
                  <select className="categoryFilter">
                    <option className="listOption" value="Something">
                      Something
                    </option>
                    <option className="listOption" value="Something">
                      Something
          ...
          <div className="box_container_home">
            <Link to="/" className="box_container_img">
              <a href="#" className="box_container_img">
                <img
                  src="https://sw.cool3c.com/user/29442/2020/c9146c0c-460f-4389-be1e-74c415a8f153.png?fit=max&w=1400&q=80"
                  alt=""
                ></img>
        ...
        <div className="btn_more">
          <a className="loadmore_btn_more" href="#">
            View More
          </a>
        </div>
      </div>
